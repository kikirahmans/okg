...
export const INITIAL_SAMPLE_RECORDS: ObservationData[] = [
  {
    ...
    guru: 'Drs. Bambang Hariyanto, M.Pd.',
    kepsek: 'Hj. Siti Rahmawati, S.Pd., M.M.',
    kelas: 'Teknik Mesin / XI TM-2',
  ...
  },
  {
    ...
    guru: 'Nurul Fitria, S.Kom.',
    kepsek: 'Hj. Siti Rahmawati, S.Pd., M.M.',
    kelas: 'Pengembangan Perangkat Lunak / X PPLG-1',
    tempat: 'SMK Negeri 1 Jakarta',
    periode: 'Januari - Juni 2026',
    tanggal: '2026-09-12',
